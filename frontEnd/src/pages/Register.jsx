...
const Register = () => {
      ...
      async function formHandler(data){
        ...
        if(response.status==200){
            ...
            reset()
            toast.error("This email already exist, try login instead")
        }
  ...
  return (
    ...
    <div className="registerBox w-1/3 h-fit box-border pb-6
       ...
       flex flex-col items-center gap-3">
        ...
        <h2 
        className='text-2xl text-white font-semibold'>Register</h2>
        ...
        className='flex flex-col items-start justify-start w-full text-white px-4 mt-4 gap-3'>
            ...
            <p className="
            self-center text-white text-xs">Already have an accout? <NavLink to={"/login"} className="text-blue-400">Login</NavLink> here</p>
